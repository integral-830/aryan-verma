    ...
    const data = [
        {
            ...
            content: (
                <div className="flex flex-col lg:flex-row items-center rounded-2xl p-2">
                    <img src={freelance} alt="img" className="w-[100px] md:w-[150px] aspect-square rounded"/>
        ...
        },
        {
            ...
            content: (
                <div className="flex flex-col lg:flex-row items-center rounded-2xl p-2">
                    <img src={youtube} alt="img" className="w-[100px] md:w-[150px] aspect-square object-cover rounded"/>
                    <div className="w-full h-full flex flex-col justify-center items-start p-8">
